...
public class GroupController extends Controller {
    ...
    public void get_group_info(){
        ...
        int user_num;
        try{
            group_info = Db.findFirst("select thegroup.*,university.uni_name,users.u_nickname,users.u_photo,users.u_id,object.obj_name,object.obj_details from thegroup,university,object,users where " +
